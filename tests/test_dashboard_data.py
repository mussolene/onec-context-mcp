...
from onec_help.runtime.dashboard_data import get_dashboard_data
...
@patch("onec_help.runtime.dashboard_data.get_index_status")
...
@patch("onec_help.runtime.dashboard_data.read_ingest_errors_log")
...
def test_load_marker_stat_oserror_returns_false(tmp_path: Path) -> None:
    ...
    with (
        patch(
            "onec_help.runtime.dashboard_data._ingest_cache_path",
...
@patch("onec_help.runtime.dashboard_data.read_last_ingest_failed", return_value=[])
@patch("onec_help.runtime.dashboard_data.read_ingest_status", return_value=None)
@patch("onec_help.runtime.dashboard_data.read_last_ingest_run", return_value={"failed_count": 2})
@patch("onec_help.runtime.dashboard_data.get_index_status", return_value={"exists": True})
@patch("onec_help.runtime.dashboard_data.get_all_collections_status", return_value=[])
def test_get_dashboard_data_fallback_ingest_failed_log(
    ...
    with (
        ...
        patch(
            "onec_help.runtime.dashboard_data.read_ingest_failed_log",
...
def test_storage_path_mb_from_env(
    ...
    with (
        ...
        patch(
            "onec_help.shared._utils.dir_size_on_disk",
...
def test_read_last_standards_run_exception_returns_none(
    ...
    with patch(
        "onec_help.runtime.dashboard_data.redis_cache.standards_last_run",
...
@patch("onec_help.runtime.dashboard_data.read_last_ingest_run", return_value=None)
@patch("onec_help.runtime.dashboard_data.get_index_status", return_value={"exists": True})
@patch("onec_help.runtime.dashboard_data.get_all_collections_status", return_value=[{"name": "c1"}])
def test_bm25_vocab_stats_skips_bad_file(
    ...
    with (
        ...
        patch(
            "onec_help.runtime.dashboard_data.bm25_vocab_path",
