...
|------------|----------|---------------------|----------------------|
| **HELP_SOURCE_BASE** / **HELP_SOURCES_DIR** | Корень каталогов с версиями 1С (.hbk) | `/opt/1cv8` | Linux/macOS. На Windows: `C:\Program Files\1cv8` или свой путь; задаётся в .env. |
...
- **HELP_SOURCE_BASE** и **HELP_SOURCES_DIR** — дублируют смысл; в коде проверяются оба. Оставить оба для обратной совместимости, в документации указать один основной (HELP_SOURCE_BASE).
