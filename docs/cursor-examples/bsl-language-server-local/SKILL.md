...
## Согласование со справкой 1С (1c-help)

BSL LS проверяет **стиль и типовые диагностики**; **семантику платформы** (доступность методов, поведение в тонком/толстом клиенте, точные сигнатуры) при спорных случаях сверяйте через MCP **1c-help**: `get_1c_api_answer`, `search_1c_api`, `answer_1c_help_question`. Диагностика «ошибка» от LS не отменяет ограничений справки и режима исполнения.
...
3. По смыслу API/ограничениям платформы — **1c-help**, не только LS.
